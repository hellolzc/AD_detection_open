...
def main(feature_type, audio_path, output_dir, name_suffix):
    assert feature_type in config_filenames, 'Unsupport feature_type: %s' % feature_type
    output_path = '%s/audio_features_%s_%s/' % (output_dir, feature_type, name_suffix)
    out_summary = '%s/func_%s_%s.csv' % (output_dir, feature_type, name_suffix)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='./..',
        type=str,
        help='dir path of output feature'
    )
    parser.add_argument(
        '-n', '--name_suffix',
        default='',
    ...
    main(args.feature_type, args.audio_path, args.output_dir, args.name_suffix)
