...
def get_time_marker(utterance):
    ...
    Time marker provides the begin and end time in milliseconds for a segment in a
    digitized video file or audio file.
    For example:
        ·0_1073·
    '·' is ASCII CODE 21(0x15) NAK(Negative Acknowledgement)
    Attention: This function only return one timer marker even the option 'multiple' is selected.
    ...
    -------
    (start stop): tuple
        two integer numbers providing the begin and end time in milliseconds for this utterance
    """
